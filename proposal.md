...
Investment firms have adopted machine learning in recent years, even some firms have started 
replacing humans with A.I. to make investment decisions.

But in this project, I apply machine learning to make a prediction of stock prices. 
Once the model has been trained, tested, and polished well, it could be used in real world 
trading.
